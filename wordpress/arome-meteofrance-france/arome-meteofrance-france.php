...
define('AMF_VERSION', '1.2.4');
define('AMF_RELEASE_DATE', '10/09/2026');
...
add_shortcode('aromepi_meteo', 'amf_render_shortcode');
...
function amf_render_settings_page() {
    ...
    <div class="wrap">
        ...
        <p><code>[aromepi_meteo code="75056" departement="75" ville="Paris" heures="48"]</code></p>
